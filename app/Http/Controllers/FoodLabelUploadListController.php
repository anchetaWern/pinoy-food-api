    ...
    public function data()
    {
        ...
        return Datatables::of($food_uploads)
            ->editColumn('title_image', function ($model) {
                return '<button class="btn btn-secondary btn-sm view-image" data-title="Title/Food Image" data-url="' . url($model->title_image) . '">View</button>';
            })
            ->editColumn('nutrition_label_image', function ($model) {
                $nutrition_label_image = ($model->nutrition_label_image) ? url($model->nutrition_label_image) : '';
            ...
            ->editColumn('ingredients_image', function ($model) {
                $ingredients_image = ($model->ingredients_image) ? url($model->ingredients_image) : '';
            ...
            ->editColumn('barcode_image', function ($model) {
                $barcode_image = ($model->barcode_image) ? url($model->barcode_image) : '';
